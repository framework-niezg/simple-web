...
-- 系统日志表
CREATE TABLE t_sys_log(id INT,operation_user VARCHAR2(30) NOT NULL,create_time DATE NOT NULL ,action VARCHAR2(40) NOT NULL ,detail VARCHAR2(1000) NOT NULL ,PRIMARY KEY (id));
create index INDEX_SYS_LOG_CREATE_TIME_USER on T_SYS_LOG (CREATE_TIME, OPERATION_USER);
