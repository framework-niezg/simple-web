...
HtmlWebpackPlugin.prototype.generateAssetTags = function (assets) {
  ...
  var scripts = assets.js.map(function (scriptPath) {
    var thScriptPath = scriptPath.substring(scriptPath.indexOf("static")+6);
    return {
      tagName: 'script',
      closeTag: true,
      attributes: {
        ...
        src: scriptPath,
        "data-th-src":"@{"+ "/resources" + thScriptPath +"}"
      }
    };
  });
  // Make tags self-closing in case of xhtml
  var selfClosingTag = !!this.options.xhtml;
  console.log(selfClosingTag);
  // Turn css files into link tags
  var styles = assets.css.map(function (stylePath) {
    var thCssPath = stylePath.substring(stylePath.indexOf("static")+6);
    return {
      tagName: 'link',
      selfClosingTag: selfClosingTag,
      attributes: {
        "data-th-href":"@{"+ "/resources"+ thCssPath +"}",
        href: stylePath,
        rel: 'stylesheet'
      }
    };
