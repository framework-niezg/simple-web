<template>
    <div id="addUser" class="card-content">
      <el-row>
        <el-col :span="12">
          <div class="detail">
            <label class="explain"><Must></Must>用户账号</label>
            <label class="result2"><el-input placeholder="请输入用户账号" :value="sendInfo.account" size="small" name="account" @change.native="inputChange"></el-input></label>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="detail">
            ...
            <label class="result2">
              <el-input placeholder="请输入用户名称" :value="sendInfo.name" size="small" name="name" @change.native="inputChange"></el-input>
            </label>
          </div>
        </el-col>
      </el-row>
      <el-row>
        <el-col :span="12">
          <div class="detail">
            ...
            <label class="result2"><el-input placeholder="请输入用户密码" type="password" :value="sendInfo.password" size="small" name="password" @change.native="inputChange"></el-input></label>
          </div>
        </el-col>
      </el-row>
    <!--  <el-row>
      ...
      <el-row>
        <el-col :span="12">
          <div class="detail">
            <label class="explain"><Must></Must>用户账号</label>
            <label class="result"><el-input placeholder="请输入用户账号" :value="sendInfo.account" size="small" name="account" @change.native="inputChange"></el-input></label>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="detail">
            <label class="explain"><Must></Must>用户密码</label>
            <label class="result"><el-input placeholder="请输入用户密码" type="password" :value="sendInfo.password" size="small" name="password" @change.native="inputChange"></el-input></label>
          </div>
        </el-col>
      </el-row>
      <el-row>
